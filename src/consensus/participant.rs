...
/// (`public_key`, `node_address`, `slot_joined`, `last_slot_voted`, `last_slot_seen`,`slot_quarantined`)
...
impl Participant {
    pub fn new(public_key: PublicKey, address: Address, joined: u64) -> Self {
        Self { public_key, address, joined, voted: None, seen: None, quarantined: None }
    }
}
